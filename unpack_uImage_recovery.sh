...
cp $FWD/$DEVICE/${UIMAGER} $SWD/$DEVICE
...
#./mkimage -A arm -O linux -T kernel -C lzma -a 80008000 -e 80008000 -d Image_rec.new.lzma -n PsquareKernel uImage_recovery
#echo ">>>>> Making aml_autoscript"
#./mkimage -A arm -O linux -T script -C none -d amltxtscript -n PsquareKernel aml_autoscript
